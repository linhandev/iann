...
class Ui_IANN(object):
    def setupUi(self, MainWindow):
        ...
        # 加载菜单栏的按钮及logo
        self.btnOpenImage = self.create_button(CentralWidget, "btnOpenImage", btn_text="加载图像", curt="Ctrl+A")
        MenuRegion.addWidget(self.btnOpenImage)  # 打开图像
        self.btnOpenFolder = self.create_button(CentralWidget, "btnOpenFolder", btn_text="打开文件夹", curt="Shift+A")
        MenuRegion.addWidget(self.btnOpenFolder)  # 打开文件夹
        self.btnUndo = self.create_button(CentralWidget, "btnUndo", btn_text="撤销", btn_ico="ui/resources/undo.png", curt="Ctrl+Z")
        MenuRegion.addWidget(self.btnUndo)  # 撤销
        self.btnRedo = self.create_button(CentralWidget, "btnRedo", btn_text="重做", btn_ico="ui/resources/redo.png", curt="Ctrl+Y")
        MenuRegion.addWidget(self.btnRedo)  # 重做
        self.btnUndoAll = self.create_button(CentralWidget, "btnUndoAll", btn_text="撤销全部", curt="Ctrl+Shift+Z")
        ...
        self.btnSLeft = self.create_button(CentralWidget, "btnSLeft", btn_ico="ui/resources/left.png", type='img', curt="A")
        ImageRegion.addWidget(self.btnSLeft)  # 上一张图
        # 图片区域
        self.PixMap = QtWidgets.QLabel(CentralWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        self.PixMap.setSizePolicy(sizePolicy)
        self.PixMap.setAutoFillBackground(False)
        self.PixMap.setStyleSheet("background-color: White")
        self.PixMap.setText("")
        self.PixMap.setObjectName("PixMap")
        ImageRegion.addWidget(self.PixMap)
        self.btnSRight = self.create_button(CentralWidget, "btnSRight", btn_ico="ui/resources/right.png", type='img', curt="D")
        ImageRegion.addWidget(self.btnSRight)  # 下一张图
        # 图像区域比例
        ...
        self.btnModelSelect = self.create_button(CentralWidget, "btnModelSelect", btn_text="模型选择", type="set")
        ...
        self.btnAddClass = self.create_button(CentralWidget, "btnAddClass", btn_text="添加标签", type='set')
        ...
        labMask.setText("蒙版透明度：")
        MaskShowRegion.addWidget(labMask)
        self.labMaskShow = QtWidgets.QLabel(CentralWidget)
        self.labMaskShow.setObjectName("labMaskShow")
        self.labMaskShow.setText("0.5")
        MaskShowRegion.addWidget(self.labMaskShow)
        MaskShowRegion.setStretch(0, 1)
        MaskShowRegion.setStretch(1, 10)
        ShowSetRegion.addLayout(MaskShowRegion)
        self.sldMask = QtWidgets.QSlider(CentralWidget)
        self.sldMask.setMaximum(10)
        self.sldMask.setSingleStep(1)
        self.sldMask.setProperty("value", 5)
        self.sldMask.setOrientation(QtCore.Qt.Horizontal)
        self.sldMask.setObjectName("sldMask")
        ShowSetRegion.addWidget(self.sldMask)
        ...
        labPointSzie.setText("可视化点击半径：")
        PointShowRegion.addWidget(labPointSzie)
        self.labPointSizeShow = QtWidgets.QLabel(CentralWidget)
        self.labPointSizeShow.setObjectName("labPointSizeShow")
        self.labPointSizeShow.setText("3")
        PointShowRegion.addWidget(self.labPointSizeShow)
        ShowSetRegion.addLayout(PointShowRegion)
        self.sldPointSzie = QtWidgets.QSlider(CentralWidget)
        self.sldPointSzie.setMaximum(10)
        self.sldPointSzie.setProperty("value", 3)
        self.sldPointSzie.setOrientation(QtCore.Qt.Horizontal)
        self.sldPointSzie.setObjectName("sldPointSzie")
        ShowSetRegion.addWidget(self.sldPointSzie)
        ...
        # 保存
        self.btnSave = self.create_button(CentralWidget, "btnSave", btn_text="保存", type='set', curt="Ctrl+S")
    ...
    ## 创建按钮
    def create_button(self, parent, btn_name, btn_text=None, btn_ico=None, type='menu', curt=None):
        # 创建和设置按钮
        if type == 'menu':
