...
from utils import get_bbox_iou, get_bbox_from_mask, expand_bbox, clamp_bbox
...
class ZoomIn(BaseTransform):
    ...
    def transform(self, image_nd, clicks_lists, mask=None):
        ...
        if update_object_roi:
            ...
            self._roi_mask = get_roi_image_nd(paddle.to_tensor(self._prev_probs), self._object_roi, self.target_size)
